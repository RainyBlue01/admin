      ...
      <div style="height: 400px;overflow-y: scroll;">
        ...
        >
          ...
          <el-form-item label="地理位置" prop="areaId">
            ...
            />
            <el-input v-model="keyword" placeholder="请填写景点地址或名称" style="width: 200px" @input="inputForMap" />
            ...
            <baidu-map v-if="checkMap" :scroll-wheel-zoom="true" class="map" :zoom="15" :center="scdes.coordinate">
              <bm-local-search
                v-model="scdes.coordinate"
                :keyword="scdes.address"
                :auto-viewport="true"
                :panel="false"
                @infohtmlset="sendRes"
                @markersset="checkMa"
          ...
          <el-form-item label="推荐指数" prop="recommendIndex">
            <el-rate v-model="scdes.recommendIndex" style="margin-top: 10px" allow-half show-score :max="10" />
          </el-form-item>
          ...
          <el-form-item label="景点描述" prop="introduction">
            <el-input v-model="scdes.introduction" type="textarea" />
          </el-form-item>
