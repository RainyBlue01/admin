<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input
        v-model="inf.condition.headline"
        placeholder="标题搜索"
        style="width: 200px;"
        class="filter-item"
      ...
      />
      <el-input
        v-model="inf.condition.daysTrip"
        placeholder="时长搜索"
        style="width: 200px;"
        class="filter-item"
        @keyup.enter.native="handleFilter"
    ...
    >
      ...
      <el-table-column label="行程历程" width="110" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.travelMileage }}km</span>
        </template>
      </el-table-column>
    ...
    >
      <div style="height: 400px;overflow-y: scroll;">
        ...
        >
          ...
          <el-form-item label="推荐指数" prop="recommendIndex">
            <el-rate
              v-model="scdes.recommendationRate"
          ...
          <el-form-item label="路书描述" prop="introduction">
            <el-input v-model="scdes.description" type="textarea" />
          </el-form-item>
          <el-form-item label="其他描述" prop="fee">
            <el-input v-model="scdes.otherDescription" type="textarea" />
          </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="resetTemp()">{{ $t('table.cancel') }}</el-button>
        <el-button
          type="primary"
...
export default {
  ...
  methods: {
    ...
    handleDialogChange(value) {
      const ar = this.$refs['cascaderAddr'].currentLabels
      this.arr = ar
